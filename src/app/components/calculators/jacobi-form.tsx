...
import { jacobi } from '@/lib/methods/jacobi';
...
export function JacobiForm() {
  ...
  function onSubmit(values: FormData) {
    const calcResult = jacobi(values.matrix, values.vector, values.initialGuess, values.tolerance, values.maxIterations);
