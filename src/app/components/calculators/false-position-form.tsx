...
import { falsePosition } from '@/lib/methods/false-position';
...
export function FalsePositionForm() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const calcResult = falsePosition(parsedFunc, values.a, values.b, values.tolerance, values.maxIterations);
             ...
             {result.error ? (
                ...
                <>
                  ...
                  <Alert>
                    ...
                    <AlertDescription>
                      Este método converge a la raíz usando una línea recta para aproximar la función. Es generalmente más rápido que el método de bisección.
                    </AlertDescription>
                  </Alert>
                </>
              )}
