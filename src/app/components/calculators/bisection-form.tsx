...
const formSchema = z
  .object({
    ...
    maxIterations: z.coerce
      .number()
      .int()
      .positive("El máximo de iteraciones debe ser un entero positivo"),
  })
  .refine(
    (data) => {
              ...
              <>
                ...
                >
                  ...
                  <AlertDescription>
                    ...
                    , obtenida después de {result.iterations.length}{" "}
                    iteraciones.
                    <br />
                    El error final es de{" "}
                    {result.iterations[
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    La raíz hallada representa el punto donde la función cambia
                    de signo. Puedes ajustar la tolerancia para obtener una
                    mayor precisión.
                  </AlertDescription>
                </Alert>
              </>
